  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white relative overflow-hidden">
      ...
      <div className="mb-8 relative z-10">
        <h2 className="text-3xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-pink-400 to-yellow-400">My Payouts</h2>
      </div>
          ...
          {payouts.length > 0 ? (
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4 inline-flex items-center">
                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-bold ${
                          payout.status === 'PAID' ? 'bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-lg shadow-green-500/20' :
                          payout.status === 'APPROVED' ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg shadow-blue-500/20' :
                          payout.status === 'PENDING' ? 'bg-gradient-to-r from-yellow-600 to-orange-600 text-white shadow-lg shadow-yellow-500/20' :
            ...
            <li>
              <div className="px-6 py-12 text-center">
                <p className="text-purple-300 text-lg font-bold">No payouts yet. Request a payout when you have sufficient commission balance.</p>
              </div>
            </li>
          )}
        </ul>
